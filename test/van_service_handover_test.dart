...
const _combinations = <_Combination>[
  (
    ...
    customerSummary: 'You will drop off and collect.',
  ...
  (
    ...
    customerSummary: 'You will drop off; we will return it to you.',
    startLabel: 'Customer drop-off',
  ...
  (
    ...
    customerSummary: 'We will collect; you will collect when ready.',
  ...
  (
    ...
    customerSummary: 'We will collect and return.',
    startLabel: 'Business collection',
    endLabel: 'Business return',
  ),
];
